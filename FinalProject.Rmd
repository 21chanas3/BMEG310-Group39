...
```
TTN, TP53, MUC16, SPOP, SYNE1, FOXA1, KMT2D, KMT2C, OBSCN, and RYR2 are the top 10 genes with highest frequency among prostate cancer patients.
...
ggplot(data= sample.name.ordered, aes(x=Var1, y=Freq))+
  geom_col()+
  scale_x_discrete(limits = sample.name.ordered$Var1) +
  labs(x = "Patients", y = "Number of Mutations", main = " Number of 
                  Mutations per Prostate Cancer Patientes")
